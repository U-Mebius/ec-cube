...
if (!class_exists('\Eccube\Entity\ClassCategory')) {
     ...
     * ClassCategory
     *
     * @ORM\Table(name="dtb_class_category", options={"comment":"規格分類"})
    ...
    class ClassCategory extends \Eccube\Entity\AbstractEntity
    {
         ...
         * @var int
         *
         * @ORM\Column(name="id", type="integer", options={"unsigned":true, "comment":"規格分類ID"})
         * @ORM\Id
         ...
         * @var string
         *
         * @ORM\Column(name="backend_name", type="string", length=255, nullable=true, options={"comment":"管理名"})
         */
